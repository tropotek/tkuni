...
CREATE TABLE IF NOT EXISTS course (
  id SERIAL PRIMARY KEY,
-- LTI course Key, Should be created if a new course is detected when users log in via LMS
-- To ensure LTI plugins can find the course the `code` must equal the `LMS context label`
