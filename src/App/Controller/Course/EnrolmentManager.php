 ...
 */
class EnrolmentManager extends Iface
{
    ...
    public function doDefault(Request $request)
    {
        ...
        $this->pendingTable = new \App\Ui\Table\PreEnrolment($this->course);
    ...
    public function show()
    {
        ...
        // Enrolment Dialog
        $template->appendTemplate('enrolment', $this->userDialog->show());
